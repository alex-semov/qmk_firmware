...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NAV] = LAYOUT(
          ...
          OS_ALT, OS_SHFT, OS_CTRL, OS_CMD, XXXXXXX,                      KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,
  ...
  [SYM] = LAYOUT(
          ...
          KC_PLUS, KC_PIPE, KC_AT,   KC_SLSH, KC_PERC,                      KC_GRV, KC_BSLS, KC_AMPR, KC_QUES, KC_EXLM,
  ...
  [NUM] = LAYOUT(
          ...
          OS_ALT, OS_SHFT, OS_CTRL, OS_CMD,  KC_F11,                       KC_F10,  OS_CMD,  OS_CTRL, OS_SHFT, OS_ALT,
